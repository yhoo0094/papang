			...
			<div align="center" class="communityFormDiv">
				<form id="frm" name="frm" action="#">
					<table class="communityFormTable" border="1">
							<tr>
								...
								<td class="whiteBackground" width="80%"><input type="text" name="title"
									class="communityFormType"></td>
							</tr>
							<tr>
								<td align="center" class="strongYellow">분류</td>
								<td class="whiteBackground"><select name="type" class="communityFormType">
										<option value="정보">정보
										<option value="일상">일상
										<option value="질문">질문
								</select></td>
							...
							<tr>
								...
								<td class="whiteBackground"><textarea class="communityFormTxtarea" rows="20" cols="102" name="comm"
										></textarea></td>
							</tr>
					</table>
					<br>
				...
				<table style="width: 100%">
						<tr>
							...
							<td align="center" width="10%" style="padding: 0 0 5px 0"><button class="btnYellow insertBtn">등록하기</button></td>
						</tr>
				</table>
				<br>
				<div align="left">
