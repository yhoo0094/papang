...
<body>
				...
				<c:forEach var="co8" items="${cos7}" >
					<tr> 
						...
						<td style="text-align: center; vertical-align: middle;"><img class ="img1" id = "pro_pic" name="pro_pic" src="${pageContext.request.contextPath}/resources/images/market/${co8.pro_pic}"></td>
