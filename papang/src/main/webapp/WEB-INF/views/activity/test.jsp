			...
			<div class="content_div">
				 ...
				 <table>
				 	<tr>
					 	<th>이름</th>
					 	<td>
					 		<input class="w3-input" type="text" id="mbr_name" name="mbr_name" readonly value="${ memberVO.mbr_name}">
					 	</td>
					 	<td rowspan="5">
					 		<img class= "img1" id = "mbr_pic" name="mbr_pic" src="${pageContext.request.contextPath}/images/memberimage/${ memberVO.mbr_pic}">
					 	</td>
				 	</tr>
					 <tr>
					 	<th>아이디</th>
					 	<td><input class="w3-input" type="text" id="mbr_id" name="mbr_id" readonly value="${ memberVO.mbr_id }"></td>
					 </tr>
					  <tr>
					 	<th>생년월일</th>
					 	<td> <input class="w3-input" type="text" id="mbr_birth" readonly name="mbr_birth" value="${ memberVO.mbr_birth }"></td>
					 </tr>
					  <tr>
					 ...
					 <tr>
					 	<td colspan="2">프로필 사진 <input type="file" id="uploadFile"  name="uploadFile" value="${ memberVO.mbr_pic}"/></td>
					 </tr>
