                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/nqInsert">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                	공지사항 등록
                            </a>
                            ...
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/lullaby">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                	자장가 관리
                            </a>
                            
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/banner">
                                <div class="sb-nav-link-icon"><i class="fas fa-tachometer-alt"></i></div>
                                	배너 관리
                            </a>
                            ...
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/sitterChart">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                                	시터 매출 현황
                            </a>
                            <a class="nav-link" href="${pageContext.request.contextPath}/admin/productChart">
                                <div class="sb-nav-link-icon"><i class="fas fa-chart-area"></i></div>
                              	 장터 매출 현황
                            </a>
                        </div>
