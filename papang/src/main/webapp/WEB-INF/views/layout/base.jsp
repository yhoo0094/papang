...
<body>
		...
		<nav class="navbar fixed-top navbar-expand-lg navbar-dark">
			<div class="container containerDiv">
				<a class="navbar-brand" href="${pageContext.request.contextPath}/">
					<img class="papanglogo" alt="로고"
					src="${pageContext.request.contextPath}/resources/images/new_logo2.png">
				</a>
				<div class="collapse navbar-collapse" id="navbarResponsive"
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath}/activity/cookList">Cook팡</a>
						</li>
						<li class="nav-item"><a class="nav-link"
				...
				<div class="util right" align="right" style="margin-bottom: 70px">
					<c:if test='${!empty admin.ad_id}'>
						<a class="item" href="${pageContext.request.contextPath}/admin"
							onfocus="blur()"> 관리자페이지로 이동</a>
					</c:if>
					<c:if test='${sessionScope.user.mbr_id != null}'>
						<span style="position: relative; cursor: pointer;"
							data-toggle="modal" data-target="#findPop"> <label
							id='alarmcount'>0</label> <img
							src="${pageContext.request.contextPath}/resources/images/login/bell1.jpg"
							style="width: 24px; border: none"></img>
						</span>
					</c:if>
					...
					<c:if test='${!empty user.mbr_id}'>
						<a class="item"
							href="${pageContext.request.contextPath}/mypage/myhome"
							onfocus="blur()"> 마이페이지</a>
					</c:if>
					<c:if test='${!empty user.mbr_id}'>
						<a class="item"
							href="${pageContext.request.contextPath}/marketList/cart"
							onfocus="blur()"> 장바구니</a>
					</c:if>
	...
	<footer class="py-5">
		<div class="container footerDiv">
			<p>
				대구광역시 중구 국채보상로 537 5층 | 대표번호 : (053)421-2460 | 사업자번호 : 573-33-00097
				| <br> 신고번호 제2021-3219632 | 대표: 강은선 김상민 문선애 조영래 최재영
			</p>
		</div>
		<!-- /.container -->
	</footer>
