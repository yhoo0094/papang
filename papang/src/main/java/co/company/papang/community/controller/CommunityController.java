...
public class CommunityController {
	...
	public String communityForm(Model model, HttpServletRequest request, HttpServletResponse response,
			CommunityVO communityVO, Community_comVO community_comVO, @CookieValue(required = false) String communuity, Boolean update) {
	...
	public String communityUpdate(Model model, CommunityVO communityVO) {
		service.communityFormUpdate(communityVO);
		model.addAttribute("update", true);
		return "redirect:/community/form?com_no=" + communityVO.getCom_no(); // jsp주소
	}
